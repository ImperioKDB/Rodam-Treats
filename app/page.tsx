...
function WhatsAppIcon({ size = 17 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
      ...
      <path d="M12.001 2C6.478 2 2 6.477 2 12c0 1.876.52 3.63 1.42 5.13L2 22l4.995-1.39A9.955 9.955 0 0 0 12.001 22C17.524 22 22 17.523 22 12S17.524 2 12.001 2zm0 18.2c-1.647 0-3.183-.46-4.494-1.258l-.322-.19-3.335.928.917-3.298-.21-.334a8.185 8.185 0 0 1-1.286-4.448c0-4.53 3.686-8.2 8.23-8.2 4.542 0 8.229 3.67 8.229 8.2 0 4.53-3.687 8.2-8.229 8.2z"/>
    </svg>
  );
}
